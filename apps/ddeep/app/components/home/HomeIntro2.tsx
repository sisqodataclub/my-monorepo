...
export default function HomeIntro2() {
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-white snap-start">
      ...
      {/* Static Blobs (Teal/Blue shift for "Clean" vibe) */}
      <div
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 h-full flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center h-full max-h-[90vh]">
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            <p className="text-base lg:text-lg text-slate-600 leading-relaxed mb-8 font-medium">
            ...
            <div className="space-y-4">
              ...
              {/* List Item 1 */}
              <div className="group flex items-center gap-4 p-3 rounded-2xl bg-white/50 border border-green-100/50 hover:bg-white hover:shadow-lg hover:shadow-green-900/5 transition-all duration-300">
          ...
          <div className="hidden lg:flex relative h-full max-h-[80vh] items-center justify-center order-1 lg:order-2">
            ...
            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-xl border border-white/50 p-4 pr-6 rounded-2xl shadow-xl flex items-center gap-4">
