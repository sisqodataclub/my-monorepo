...
class ResumeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Resume
        fields = (
            'id', 'full_name', 'about', 'age', 'email', 'phone',
...
class JobApplicationSerializer(serializers.ModelSerializer):
    # Optional: include resume details if needed
    # resume_details = ResumeSerializer(source='resume_used', read_only=True)

    class Meta:
        model = JobApplication
        fields = (
            'id', 'job_link', 'company', 'position', 'date_applied',
