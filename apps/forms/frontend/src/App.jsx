...
function Home() {
  ...
  return (
    <div className="relative z-0 bg-primary min-h-screen text-white">
      ...
      {/* SEO HELMET BLOCK (homepage specific) */}
      <Helmet>
...
const App = () => {
  ...
  return (
    <>
      {/* ✅ GLOBAL UMAMI ANALYTICS (loads on every page) */}
      <Helmet>
        <script
          defer
          src="https://analytics.ddeepcleaningservices.com/script.js"
          data-website-id="827c5bef-c752-4fb1-85eb-b0b864319b6a"
        />
      </Helmet>
